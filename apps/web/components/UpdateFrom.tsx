...
import { updateItem, getOneItems } from '@/actions/item';
...
const UpdateForm: React.FC<UpdateFormProps> = ({ itemId }) => {
    ...
    useEffect(() => {
        const loadItemData = async () => {
            try {
                ...
                setErrors({ general: 'Failed to load item data' });
            } finally {
                setIsLoading(false);
            }
        };
    ...
    const handleSubmit = async (): Promise<void> => {
        ...
        try {
            ...
            const response = await updateItem(submitData, itemId);
            ...
            // Optionally redirect back to item view or list
            // router.push(`/items/${itemId}`);
            
        } catch (error) {
            console.error('Error updating item:', error);
            setErrors({ general: 'Error updating item. Please try again.' });
        } finally {
                ...
                <div className="max-w-2xl mx-auto p-6 bg-gray-50 shadow-lg rounded-lg text-black">
                    <div className="flex items-center justify-center h-64">
                        <div className="flex flex-col items-center">
                            ...
                            <p className="text-sm text-gray-500">Loading item data...</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    return (
        <div className='bg-white py-10'>
            <div className="max-w-2xl mx-auto p-6 bg-gray-50 shadow-lg rounded-lg text-black">
                <h2 className="text-2xl font-bold text-gray-800 mb-6">Update Item</h2>
                ...
                <div className="space-y-6">
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-xs text-gray-500">
                                You can upload a new image or update the image URL
                            </p>
                        </div>
                    ...
                    <div className="pt-4 flex gap-4">
                        <button
                            ...
                            className={`flex-1 py-3 px-4 rounded-md text-white font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${
                                isSubmitting 
                        ...
                        <button
                            type="button"
                            onClick={() => router.back()}
                            className="px-6 py-3 border border-gray-300 rounded-md text-gray-700 font-medium hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                        >
                            Cancel
                        </button>
                    </div>
