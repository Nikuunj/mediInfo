        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors">Medical Database</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors">Expert Network</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors">Health Tracking</a></li>
            </ul>
          </div>
